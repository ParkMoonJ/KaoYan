...
- 产生初始归并段（置换选择算法）$\to$多路归并排序（借助败者树减少时间复杂度）
- 对于 m 路归并需要 m 个输入缓冲区和一个输出缓冲区
- 外排非重点，只需要掌握考点即可，不用纠结复杂度、公式等
...
- 道上佬：计算归并次数、理解内存中缓冲区个数

> 小题：1，2，6，7  
> 大题：1

- 道上仙：结合多路归并、m 叉哈夫曼树理解外部排序
